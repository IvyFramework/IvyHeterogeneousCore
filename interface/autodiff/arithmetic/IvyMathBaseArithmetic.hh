...
namespace IvyMath{
  ...
  public:
    __HOST__ IvyNegate(IvyThreadSafePtr_t<T> const& dep);
    __HOST__ IvyNegate(IvyNegate const& other);
    __HOST__ IvyNegate(IvyNegate&& other);
  ...
  template<typename T, typename domain_tag = get_domain_t<T>> struct MultInverseFcnal{
    ...
    static __INLINE_FCN_FORCE__ __HOST_DEVICE__ value_t eval(T const& x);
    static __INLINE_FCN_FORCE__ __HOST_DEVICE__ grad_t gradient(T const& x);
  };
  ...
  template<typename T> struct SqrtFcnal<T, real_domain_tag>{
    ...
    using grad_t = value_t;
    static __HOST_DEVICE__ value_t eval(T const& x);
    static __HOST_DEVICE__ grad_t gradient(T const& x);
  };
  ...
  template<typename T, typename domain_tag = get_domain_t<T>> struct PhaseFcnal{
    ...
    static __HOST_DEVICE__ constexpr grad_t gradient(T const& x);
  };
  ...
  public:
    __HOST__ IvyAdd(IvyThreadSafePtr_t<T> const& x, IvyThreadSafePtr_t<U> const& y);
    __HOST__ IvyAdd(IvyAdd const& other);
    __HOST__ IvyAdd(IvyAdd&& other);
  ...
  template<typename T, typename U> struct SubtractFcnal<T, U, real_domain_tag, real_domain_tag>{
    ...
    static __HOST_DEVICE__ value_t eval(T const& x, U const& y);
    static __INLINE_FCN_FORCE__ __HOST_DEVICE__ grad_x_t gradient_x(T const& x, U const& y);
    static __INLINE_FCN_FORCE__ __HOST_DEVICE__ grad_y_t gradient_y(T const& x, U const& y);
  };
  ...
  public:
    __HOST__ IvyMultiply(IvyThreadSafePtr_t<T> const& x, IvyThreadSafePtr_t<U> const& y);
    __HOST__ IvyMultiply(IvyMultiply const& other);
    __HOST__ IvyMultiply(IvyMultiply&& other);
