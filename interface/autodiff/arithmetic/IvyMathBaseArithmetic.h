...
namespace IvyMath{
  ...
  template<typename T>
  __HOST_DEVICE__ RealFcnal<T, complex_domain_tag>::value_t RealFcnal<T, complex_domain_tag>::eval(T const& x){ return x.Re(); }
  ...
  template<typename T>
  __HOST_DEVICE__ ImagFcnal<T, complex_domain_tag>::value_t ImagFcnal<T, complex_domain_tag>::eval(T const& x){ return x.Im(); }
  ...
  template<typename T>
  __HOST_DEVICE__ IsIntegerFcnal<T, complex_domain_tag>::value_t IsIntegerFcnal<T, complex_domain_tag>::eval(T const& x){ return IsIntegerFcnal::eval(x.Re()) && x.Im()==Zero<T>(); }
  ...
  template<typename T>
  __HOST_DEVICE__ IsRealFcnal<T, complex_domain_tag>::value_t IsRealFcnal<T, complex_domain_tag>::eval(T const& x){ return x.Im()==Zero<T>(); }
  ...
  template<typename T>
  __HOST_DEVICE__ IsImaginaryFcnal<T, complex_domain_tag>::value_t IsImaginaryFcnal<T, complex_domain_tag>::eval(T const& x){ return x.Re()==Zero<T>() && x.Im()!=Zero<T>(); }
  ...
  template<typename T>
  __HOST_DEVICE__ NegateFcnal<T, real_domain_tag>::value_t NegateFcnal<T, real_domain_tag>::eval(T const& x){ return value_t(-x.value()); }
  template<typename T>
  ...
  template<typename T>
  __HOST_DEVICE__ NegateFcnal<T, complex_domain_tag>::value_t NegateFcnal<T, complex_domain_tag>::eval(T const& x){ return value_t(-x.Re(), -x.Im()); }
  template<typename T>
  ...
  template<typename T> __HOST__ IvyNegate<T>::IvyNegate(IvyThreadSafePtr_t<T> const& dep) : base_t(), dep(dep){}
  template<typename T> __HOST__ IvyNegate<T>::IvyNegate(IvyNegate<T> const& other) : base_t(other), dep(other.dep){}
  template<typename T> __HOST__ IvyNegate<T>::IvyNegate(IvyNegate<T>&& other) : base_t(std_util::move(other)), dep(std_util::move(other.dep)){}
  template<typename T> __HOST__ void IvyNegate<T>::eval() const{
    *(this->output) = Evaluator::eval(unpack_function_input<T>::get(*dep));
  }
  template<typename T> __HOST__ bool IvyNegate<T>::depends_on(IvyBaseNode const* node) const{
    return (base_t::depends_on(node) || IvyMath::depends_on(dep, node));
  }
  template<typename T> __HOST__ IvyThreadSafePtr_t<typename IvyNegate<T>::grad_t> IvyNegate<T>::gradient(
  ...
  __HOST_DEVICE__ IvyThreadSafePtr_t<typename IvyNegate<T>::base_t> Negate(T const& x){
  ...
  template<typename T, ENABLE_IF_BOOL_IMPL(is_pointer_v<T>)>
  __HOST_DEVICE__ IvyThreadSafePtr_t<typename IvyNegate<T>::base_t> operator-(T const& x){
    return Negate(x);
  }
  ...
  template<typename T, typename domain_tag>
  __HOST_DEVICE__ MultInverseFcnal<T, domain_tag>::grad_t MultInverseFcnal<T, domain_tag>::gradient(T const& x){ return MinusOne<value_t>()/(x*x); }
  template<typename T>
  __HOST_DEVICE__ MultInverseFcnal<T, real_domain_tag>::value_t MultInverseFcnal<T, real_domain_tag>::eval(T const& x){ return value_t(MultInverse(x.value())); }
  template<typename T>
  __HOST_DEVICE__ MultInverseFcnal<T, real_domain_tag>::grad_t MultInverseFcnal<T, real_domain_tag>::gradient(T const& x){ return value_t(-One<dtype_t>()/(x.value()*x.value())); }
  template<typename T>
  ...
  template<typename T>
  __HOST_DEVICE__ MultInverseFcnal<T, complex_domain_tag>::grad_t MultInverseFcnal<T, complex_domain_tag>::gradient(T const& x){
    auto const r = MultInverse(x.norm());
    auto const phi = x.phase();
  ...
  template<typename T, typename domain_tag>
  __HOST_DEVICE__ SqrtFcnal<T, domain_tag>::grad_t SqrtFcnal<T, domain_tag>::gradient(T const& x){ return OneHalf<dtype_t>/SqrtFcnal<T>::eval(x); }
  template<typename T>
  __HOST_DEVICE__ SqrtFcnal<T, real_domain_tag>::value_t SqrtFcnal<T, real_domain_tag>::eval(T const& x){ return value_t(SqrtFcnal<dtype_t>::eval(x.value())); }
  template<typename T>
  __HOST_DEVICE__ SqrtFcnal<T, real_domain_tag>::grad_t SqrtFcnal<T, real_domain_tag>::gradient(T const& x){ return value_t(SqrtFcnal<dtype_t>::gradient(x.value())); }
  template<typename T>
  ...
  template<typename T, typename domain_tag>
  __HOST_DEVICE__ AbsFcnal<T, domain_tag>::grad_t AbsFcnal<T, domain_tag>::gradient(T const& x){ return std_math::abs(x)/x; }
  template<typename T>
  __HOST_DEVICE__ AbsFcnal<T, real_domain_tag>::value_t AbsFcnal<T, real_domain_tag>::eval(T const& x){
    return value_t(Abs(x.value()));
  }
  template<typename T>
  __HOST_DEVICE__ AbsFcnal<T, real_domain_tag>::grad_t AbsFcnal<T, real_domain_tag>::gradient(T const& x){
    value_t res(x.value());
  ...
  template<typename T, typename domain_tag>
  __HOST_DEVICE__ constexpr PhaseFcnal<T, domain_tag>::grad_t PhaseFcnal<T, domain_tag>::gradient(T const& x){ return value_t(Zero<dtype_t>); }
  template<typename T>
  __HOST_DEVICE__ PhaseFcnal<T, complex_domain_tag>::value_t PhaseFcnal<T, complex_domain_tag>::eval(T const& x){ return value_t(x.phase()); }
  ...
  // CONJUGATION
  template<typename T, typename domain_tag>
  __HOST_DEVICE__ ConjugateFcnal<T, domain_tag>::value_t ConjugateFcnal<T, domain_tag>::eval(T const& x){ value_t res(x.value()); conjugate(res); return res; }
  template<typename T, typename domain_tag>
  __HOST_DEVICE__ constexpr ConjugateFcnal<T, domain_tag>::grad_t ConjugateFcnal<T, domain_tag>::gradient(T const& x){ return grad_t(One<dtype_t>); }
  ...
  template<typename T, typename domain_tag>
  __HOST_DEVICE__ ExpFcnal<T, domain_tag>::grad_t ExpFcnal<T, domain_tag>::gradient(T const& x){ return ExpFcnal<T, domain_tag>::eval(x); }
  template<typename T>
  __HOST_DEVICE__ ExpFcnal<T, real_domain_tag>::value_t ExpFcnal<T, real_domain_tag>::eval(T const& x){ return value_t(Exp(x.value())); }
  template<typename T>
  __HOST_DEVICE__ ExpFcnal<T, real_domain_tag>::grad_t ExpFcnal<T, real_domain_tag>::gradient(T const& x){ return ExpFcnal<T, real_domain_tag>::eval(x); }
  template<typename T>
  ...
  template<typename T>
  __HOST_DEVICE__ ExpFcnal<T, complex_domain_tag>::grad_t ExpFcnal<T, complex_domain_tag>::gradient(T const& x){ return ExpFcnal<T, complex_domain_tag>::eval(x); }
  ...
  template<typename T, typename domain_tag>
  __HOST_DEVICE__ LogFcnal<T, domain_tag>::grad_t LogFcnal<T, domain_tag>::gradient(T const& x){ return One<value_t>()/x; }
  template<typename T>
  __HOST_DEVICE__ LogFcnal<T, real_domain_tag>::value_t LogFcnal<T, real_domain_tag>::eval(T const& x){ return value_t(Log(x.value())); }
  template<typename T>
  __HOST_DEVICE__ LogFcnal<T, real_domain_tag>::grad_t LogFcnal<T, real_domain_tag>::gradient(T const& x){ return value_t(One<dtype_t>()/x.value()); }
  template<typename T>
  ...
  template<typename T>
  __HOST_DEVICE__ LogFcnal<T, complex_domain_tag>::grad_t LogFcnal<T, complex_domain_tag>::gradient(T const& x){
  ...
  template<typename T, typename domain_tag>
  __HOST_DEVICE__ Log10Fcnal<T, domain_tag>::grad_t Log10Fcnal<T, domain_tag>::gradient(T const& x){ return LogFcnal<T, domain_tag>::gradient(x)/LogTen<value_t>(); }
  template<typename T>
  __HOST_DEVICE__ Log10Fcnal<T, real_domain_tag>::value_t Log10Fcnal<T, real_domain_tag>::eval(T const& x){ return value_t(Log10(x.value())); }
  template<typename T>
  __HOST_DEVICE__ Log10Fcnal<T, real_domain_tag>::grad_t Log10Fcnal<T, real_domain_tag>::gradient(T const& x){
  ...
  template<typename T>
  __HOST_DEVICE__ Log10Fcnal<T, complex_domain_tag>::grad_t Log10Fcnal<T, complex_domain_tag>::gradient(T const& x){
  ...
  template<typename T, typename domain_tag>
  __HOST_DEVICE__ SinFcnal<T, domain_tag>::grad_t SinFcnal<T, domain_tag>::gradient(T const& x){ return Cos(x); }
  template<typename T>
  __HOST_DEVICE__ SinFcnal<T, real_domain_tag>::value_t SinFcnal<T, real_domain_tag>::eval(T const& x){ return value_t(Sin(x.value())); }
  template<typename T>
  __HOST_DEVICE__ SinFcnal<T, real_domain_tag>::grad_t SinFcnal<T, real_domain_tag>::gradient(T const& x){ return Cos(x); }
  template<typename T>
  ...
  template<typename T>
  __HOST_DEVICE__ SinFcnal<T, complex_domain_tag>::grad_t SinFcnal<T, complex_domain_tag>::gradient(T const& x){ return Cos(x); }
  ...
  template<typename T, typename domain_tag>
  __HOST_DEVICE__ CosFcnal<T, domain_tag>::grad_t CosFcnal<T, domain_tag>::gradient(T const& x){ return -Sin(x); }
  template<typename T>
  __HOST_DEVICE__ CosFcnal<T, real_domain_tag>::value_t CosFcnal<T, real_domain_tag>::eval(T const& x){ return value_t(Cos(x.value())); }
  template<typename T>
  __HOST_DEVICE__ CosFcnal<T, real_domain_tag>::grad_t CosFcnal<T, real_domain_tag>::gradient(T const& x){ return -Sin(x); }
  template<typename T>
  ...
  template<typename T>
  __HOST_DEVICE__ CosFcnal<T, complex_domain_tag>::grad_t CosFcnal<T, complex_domain_tag>::gradient(T const& x){ return -Sin(x); }
  ...
  template<typename T, typename domain_tag>
  __HOST_DEVICE__ TanFcnal<T, domain_tag>::grad_t TanFcnal<T, domain_tag>::gradient(T const& x){ auto r = Sec(x); return r*r; }
  ...
  template<typename T, typename domain_tag>
  __HOST_DEVICE__ SecFcnal<T, domain_tag>::grad_t SecFcnal<T, domain_tag>::gradient(T const& x){ return Sec(x)*Tan(x); }
  ...
  template<typename T, typename domain_tag>
  __HOST_DEVICE__ CscFcnal<T, domain_tag>::grad_t CscFcnal<T, domain_tag>::gradient(T const& x){ return -Csc(x)*Cot(x);; }
  ...
  template<typename T, typename domain_tag>
  __HOST_DEVICE__ CotFcnal<T, domain_tag>::grad_t CotFcnal<T, domain_tag>::gradient(T const& x){ auto r = Csc(x); return -r*r; }
  ...
  template<typename T, typename domain_tag>
  __HOST_DEVICE__ SinHFcnal<T, domain_tag>::grad_t SinHFcnal<T, domain_tag>::gradient(T const& x){ return CosH(x); }
  template<typename T>
  __HOST_DEVICE__ SinHFcnal<T, real_domain_tag>::value_t SinHFcnal<T, real_domain_tag>::eval(T const& x){ return value_t(SinH(x.value())); }
  template<typename T>
  __HOST_DEVICE__ SinHFcnal<T, real_domain_tag>::grad_t SinHFcnal<T, real_domain_tag>::gradient(T const& x){ return CosH(x); }
  template<typename T>
  ...
  template<typename T>
  __HOST_DEVICE__ SinHFcnal<T, complex_domain_tag>::grad_t SinHFcnal<T, complex_domain_tag>::gradient(T const& x){ return CosH(x); }
  ...
  template<typename T, typename domain_tag>
  __HOST_DEVICE__ CosHFcnal<T, domain_tag>::grad_t CosHFcnal<T, domain_tag>::gradient(T const& x){ return SinH(x); }
  template<typename T>
  __HOST_DEVICE__ CosHFcnal<T, real_domain_tag>::value_t CosHFcnal<T, real_domain_tag>::eval(T const& x){ return value_t(CosH(x.value())); }
  template<typename T>
  __HOST_DEVICE__ CosHFcnal<T, real_domain_tag>::grad_t CosHFcnal<T, real_domain_tag>::gradient(T const& x){ return SinH(x); }
  template<typename T>
  ...
  template<typename T>
  __HOST_DEVICE__ CosHFcnal<T, complex_domain_tag>::grad_t CosHFcnal<T, complex_domain_tag>::gradient(T const& x){ return CosH(x); }
  ...
  template<typename T, typename U>
  __HOST_DEVICE__ AddFcnal<T, U, real_domain_tag, real_domain_tag>::grad_t AddFcnal<T, U, real_domain_tag, real_domain_tag>::gradient(unsigned char, IvyThreadSafePtr_t<T> const& x, IvyThreadSafePtr_t<U> const& y){
  ...
  template<typename T, typename U>
  __HOST_DEVICE__ AddFcnal<T, U, complex_domain_tag, complex_domain_tag>::grad_t AddFcnal<T, U, complex_domain_tag, complex_domain_tag>::gradient(unsigned char ivar, IvyThreadSafePtr_t<T> const& x, IvyThreadSafePtr_t<U> const& y){
    return make_IvyThreadSafePtr<typename grad_t::element_type>(x.get_memory_type(), x.gpu_stream(), One<fndtype_t>());
  }
  template<typename T, typename U>
  ...
  template<typename T, typename U>
  __HOST_DEVICE__ AddFcnal<T, U, real_domain_tag, complex_domain_tag>::grad_t AddFcnal<T, U, real_domain_tag, complex_domain_tag>::gradient(unsigned char ivar, IvyThreadSafePtr_t<T> const& x, IvyThreadSafePtr_t<U> const& y){
    return make_IvyThreadSafePtr<typename grad_t::element_type>(x.get_memory_type(), x.gpu_stream(), One<fndtype_t>());
  }
  template<typename T, typename U>
  ...
  template<typename T, typename U>
  __HOST_DEVICE__ AddFcnal<T, U, complex_domain_tag, real_domain_tag>::grad_t AddFcnal<T, U, complex_domain_tag, real_domain_tag>::gradient(unsigned char ivar, IvyThreadSafePtr_t<T> const& x, IvyThreadSafePtr_t<U> const& y){
    return make_IvyThreadSafePtr<typename grad_t::element_type>(x.get_memory_type(), x.gpu_stream(), One<fndtype_t>());
  }
  ...
  template<typename T, typename U> __HOST__ IvyAdd<T, U>::IvyAdd(IvyThreadSafePtr_t<T> const& x, IvyThreadSafePtr_t<U> const& y) : base_t(), x(x), y(y){}
  template<typename T, typename U> __HOST__ IvyAdd<T, U>::IvyAdd(IvyAdd<T, U> const& other) : base_t(other), x(other.x), y(other.y){}
  template<typename T, typename U> __HOST__ IvyAdd<T, U>::IvyAdd(IvyAdd<T, U>&& other) :
    base_t(std_util::move(other)), x(std_util::move(other.x)), y(std_util::move(other.y)){}
  template<typename T, typename U> __HOST__ void IvyAdd<T, U>::eval() const{
    *(this->output) = Evaluator::eval(unpack_function_input<T>::get(*x), unpack_function_input<U>::get(*y));
  }
  template<typename T, typename U> __HOST__ bool IvyAdd<T, U>::depends_on(IvyBaseNode const* node) const{
    return (base_t::depends_on(node) || IvyMath::depends_on(x, node) || IvyMath::depends_on(y, node));
  }
  template<typename T, typename U> __HOST__ IvyThreadSafePtr_t<typename IvyAdd<T, U>::grad_t> IvyAdd<T, U>::gradient(
    IvyThreadSafePtr_t<IvyBaseNode> const& var
  ) const{
  ...
  template<typename T, typename U, ENABLE_IF_BOOL_IMPL(is_pointer_v<T> && is_pointer_v<U>)>
  __HOST_DEVICE__ IvyThreadSafePtr_t<typename IvyAdd<T, U>::base_t> Add(T const& x, U const& y){
    constexpr std_ivy::IvyMemoryType def_mem_type = IvyMemoryHelpers::get_execution_default_memory();
    return make_IvyThreadSafePtr<IvyAdd<T, U>>(def_mem_type, nullptr, IvyAdd(x, y));
  }
  template<typename T, typename U, ENABLE_IF_BOOL_IMPL(is_pointer_v<T> && is_pointer_v<U>)>
  __HOST_DEVICE__ IvyThreadSafePtr_t<typename IvyAdd<T, U>::base_t> operator+(T const& x, U const& y){
    return Add(x, y);
  }
  ...
  template<typename T, typename U>
  __HOST_DEVICE__ SubtractFcnal<T, U, real_domain_tag, real_domain_tag>::grad_x_t SubtractFcnal<T, U, real_domain_tag, real_domain_tag>::gradient_x(T const& x, U const& y){
    return grad_x_t(One<reduced_data_t<T>>());
  }
  template<typename T, typename U>
  __HOST_DEVICE__ SubtractFcnal<T, U, real_domain_tag, real_domain_tag>::grad_y_t SubtractFcnal<T, U, real_domain_tag, real_domain_tag>::gradient_y(T const& x, U const& y){
  ...
  template<typename T, typename U>
  __HOST_DEVICE__ SubtractFcnal<T, U, complex_domain_tag, complex_domain_tag>::grad_x_t SubtractFcnal<T, U, complex_domain_tag, complex_domain_tag>::gradient_x(T const& x, U const& y){
    return grad_x_t(One<reduced_data_t<T>>());
  }
  template<typename T, typename U>
  __HOST_DEVICE__ SubtractFcnal<T, U, complex_domain_tag, complex_domain_tag>::grad_y_t SubtractFcnal<T, U, complex_domain_tag, complex_domain_tag>::gradient_y(T const& x, U const& y){
    return grad_y_t(MinusOne<reduced_data_t<U>>());
  }
  template<typename T, typename U>
  ...
  template<typename T, typename U>
  __HOST_DEVICE__ SubtractFcnal<T, U, real_domain_tag, complex_domain_tag>::grad_x_t SubtractFcnal<T, U, real_domain_tag, complex_domain_tag>::gradient_x(T const& x, U const& y){
    return grad_x_t(One<reduced_data_t<T>>());
  }
  template<typename T, typename U>
  __HOST_DEVICE__ SubtractFcnal<T, U, real_domain_tag, complex_domain_tag>::grad_y_t SubtractFcnal<T, U, real_domain_tag, complex_domain_tag>::gradient_y(T const& x, U const& y){
    return grad_y_t(MinusOne<reduced_data_t<U>>());
  }
  template<typename T, typename U>
  ...
  template<typename T, typename U>
  __HOST_DEVICE__ SubtractFcnal<T, U, complex_domain_tag, real_domain_tag>::grad_x_t SubtractFcnal<T, U, complex_domain_tag, real_domain_tag>::gradient_x(T const& x, U const& y){
    return grad_x_t(One<reduced_data_t<T>>());
  }
  template<typename T, typename U>
  __HOST_DEVICE__ SubtractFcnal<T, U, complex_domain_tag, real_domain_tag>::grad_y_t SubtractFcnal<T, U, complex_domain_tag, real_domain_tag>::gradient_y(T const& x, U const& y){
    return grad_y_t(MinusOne<reduced_data_t<U>>());
  }
  template<typename T, typename U, ENABLE_IF_BOOL_IMPL(!is_pointer_v<T> && !is_pointer_v<U>)>
  ...
  template<typename T, typename U>
  __HOST_DEVICE__ MultiplyFcnal<T, U, real_domain_tag, real_domain_tag>::grad_t MultiplyFcnal<T, U, real_domain_tag, real_domain_tag>::gradient(unsigned char ivar, IvyThreadSafePtr_t<T> const& x, IvyThreadSafePtr_t<U> const& y){
    switch (ivar){
    case 0:
  ...
  template<typename T, typename U>
  __HOST_DEVICE__ MultiplyFcnal<T, U, real_domain_tag, complex_domain_tag>::grad_t MultiplyFcnal<T, U, real_domain_tag, complex_domain_tag>::gradient(unsigned char ivar, IvyThreadSafePtr_t<T> const& x, IvyThreadSafePtr_t<U> const& y){
    switch (ivar){
    case 0:
      return make_IvyThreadSafePtr<typename grad_t::element_type>(x.get_memory_type(), x.gpu_stream(), One<fndtype_t>()) * y;
    default:
  ...
  template<typename T, typename U>
  __HOST_DEVICE__ MultiplyFcnal<T, U, complex_domain_tag, real_domain_tag>::grad_t MultiplyFcnal<T, U, complex_domain_tag, real_domain_tag>::gradient(unsigned char ivar, IvyThreadSafePtr_t<T> const& x, IvyThreadSafePtr_t<U> const& y){
    switch (ivar){
    case 0:
      return make_IvyThreadSafePtr<typename grad_t::element_type>(x.get_memory_type(), x.gpu_stream(), One<fndtype_t>()) * y;
    default:
  ...
  template<typename T, typename U> __HOST__ IvyMultiply<T, U>::IvyMultiply(IvyThreadSafePtr_t<T> const& x, IvyThreadSafePtr_t<U> const& y) : base_t(), x(x), y(y){}
  template<typename T, typename U> __HOST__ IvyMultiply<T, U>::IvyMultiply(IvyMultiply<T, U> const& other) : base_t(other), x(other.x), y(other.y){}
  template<typename T, typename U> __HOST__ IvyMultiply<T, U>::IvyMultiply(IvyMultiply<T, U>&& other) :
    base_t(std_util::move(other)), x(std_util::move(other.x)), y(std_util::move(other.y)){}
  template<typename T, typename U> __HOST__ void IvyMultiply<T, U>::eval() const{
    *(this->output) = Evaluator::eval(unpack_function_input<T>::get(*x), unpack_function_input<U>::get(*y));
  }
  template<typename T, typename U> __HOST__ bool IvyMultiply<T, U>::depends_on(IvyBaseNode const* node) const{
    return (base_t::depends_on(node) || IvyMath::depends_on(x, node) || IvyMath::depends_on(y, node));
  }
  template<typename T, typename U> __HOST__ IvyThreadSafePtr_t<typename IvyMultiply<T, U>::grad_t> IvyMultiply<T, U>::gradient(
    IvyThreadSafePtr_t<IvyBaseNode> const& var
  ) const{
    auto grad_x = function_gradient<T>::get(*x, var);
    auto grad_y = function_gradient<U>::get(*y, var);
  ...
  template<typename T, typename U, ENABLE_IF_BOOL_IMPL(is_pointer_v<T>&& is_pointer_v<U>)>
  __HOST_DEVICE__ IvyThreadSafePtr_t<typename IvyMultiply<T, U>::base_t> Multiply(T const& x, U const& y){
    constexpr std_ivy::IvyMemoryType def_mem_type = IvyMemoryHelpers::get_execution_default_memory();
    return make_IvyThreadSafePtr<IvyMultiply<T, U>>(def_mem_type, nullptr, IvyMultiply(x, y));
  }
  template<typename T, typename U, ENABLE_IF_BOOL_IMPL(is_pointer_v<T>&& is_pointer_v<U>)>
  __HOST_DEVICE__ IvyThreadSafePtr_t<typename IvyMultiply<T, U>::base_t> operator+(T const& x, U const& y){
    return Multiply(x, y);
  }
  ...
  template<typename T, typename U>
  __HOST_DEVICE__ DivideFcnal<T, U, real_domain_tag, real_domain_tag>::grad_x_t DivideFcnal<T, U, real_domain_tag, real_domain_tag>::gradient_x(T const& x, U const& y){
    return MultInverse(y.value());
  }
  template<typename T, typename U>
  __HOST_DEVICE__ DivideFcnal<T, U, real_domain_tag, real_domain_tag>::grad_y_t DivideFcnal<T, U, real_domain_tag, real_domain_tag>::gradient_y(T const& x, U const& y){
  ...
  template<typename T, typename U>
  __HOST_DEVICE__ DivideFcnal<T, U, complex_domain_tag, complex_domain_tag>::grad_x_t DivideFcnal<T, U, complex_domain_tag, complex_domain_tag>::gradient_x(T const& x, U const& y){
    return MultInverse(y.value());
  }
  template<typename T, typename U>
  __HOST_DEVICE__ DivideFcnal<T, U, complex_domain_tag, complex_domain_tag>::grad_y_t DivideFcnal<T, U, complex_domain_tag, complex_domain_tag>::gradient_y(T const& x, U const& y){
    auto yinv = MultInverse(y.value());
    auto myinvt = -yinv*yinv;
    return x.value()*myinvt.value();
  }
  ...
  template<typename T, typename U>
  __HOST_DEVICE__ DivideFcnal<T, U, real_domain_tag, complex_domain_tag>::grad_x_t DivideFcnal<T, U, real_domain_tag, complex_domain_tag>::gradient_x(T const& x, U const& y){
    return MultInverse(y.value());
  }
  template<typename T, typename U>
  __HOST_DEVICE__ DivideFcnal<T, U, real_domain_tag, complex_domain_tag>::grad_y_t DivideFcnal<T, U, real_domain_tag, complex_domain_tag>::gradient_y(T const& x, U const& y){
    auto yinv = MultInverse(y.value());
    auto myinvt = -yinv*yinv;
    return x.value()*myinvt.value();
  }
  ...
  template<typename T, typename U>
  __HOST_DEVICE__ DivideFcnal<T, U, complex_domain_tag, real_domain_tag>::grad_x_t DivideFcnal<T, U, complex_domain_tag, real_domain_tag>::gradient_x(T const& x, U const& y){
    return MultInverse(y.value());
  }
  template<typename T, typename U>
  __HOST_DEVICE__ DivideFcnal<T, U, complex_domain_tag, real_domain_tag>::grad_y_t DivideFcnal<T, U, complex_domain_tag, real_domain_tag>::gradient_y(T const& x, U const& y){
    auto yinv = MultInverse(y.value());
    auto myinvt = -yinv*yinv;
    return x.value()*myinvt.value();
  }
